...
namespace LBSoft.IndustrialCtrls.Meters
{
    ...
    public partial class LBDigitalMeter : LBIndustrialCtrlBase
    {
        ...
        public double Value
        {
            set
            {
                ...
                LBMeterEventArgs e = new LBMeterEventArgs();
                e.Value = (float) value;
                this.OnMeterChangeValue(e);
            }
        ...
        #region (* Fire events *)
        public event MeterChangeValue MeterChangeValue;
        protected virtual void OnMeterChangeValue(LBMeterEventArgs e)
        {
            if (this.MeterChangeValue != null)
                this.MeterChangeValue(this, e);
        }
        #endregion
    ...
    /// </summary>
    public class LBMeterEventArgs : EventArgs
    {
        private float val;

        public LBMeterEventArgs()
        {
        }
    ...
    #region (* Delegates *)
    public delegate void MeterChangeValue(object sender, LBMeterEventArgs e);
    #endregion
}
