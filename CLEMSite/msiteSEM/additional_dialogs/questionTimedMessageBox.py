...
class QuestionTimedMessageBox(MBox):
    """
    ...
    def __init__(self, timeout=5, buttons=None, **kwargs):
        ...
        super(QuestionTimedMessageBox, self).__init__(parent=None)
    ...
    def showEvent(self, e):
        super(QuestionTimedMessageBox, self).showEvent(e)
        self.tick()
        self.timer.start()
    ...
    def question(**kwargs):
        ...
        """
        w = QuestionTimedMessageBox(**kwargs)
...
if __name__ == "__main__":
    ...
    w = QuestionTimedMessageBox.question(text="Please select something",
